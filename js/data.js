...
(function () {
  ...
  GG.CONFIG = {
    ...
    sagaBreakLegend: 10,     // lifetime ✦ Legend needed to unlock the "break the Bargain" finale door
    sagaTurnLegend: 16,      // lifetime ✦ Legend needed to unlock the "turn the Bargain" finale door
  };
  ...
  GG.NOTABLE = {
    names: ['Murt', 'Skrik', 'Pim', 'Hobnail', 'Veen', 'Klud', 'Bog', 'Wretcha',
            ...
            'Gritch', 'Pudge', 'Varn', 'Zobb', 'Kess', 'Thrub', 'Sneel', 'Wibble'],
    roles: ['the Forager', 'the Digger', 'the Raider', 'the Tinker', 'the Cook',
            'the Shaman', 'the Lookout', 'the Brewer', 'the Storyteller',
            'the Bone-Setter', 'the Scavenger', 'the Tunneler', 'the Ward-Keeper',
            'the Mud-Miner', 'the Pot-Stirrer'],
    prefixes: [
      'Ancient', 'Battle-Scarred', 'Big-Eared', 'Bold', 'Broken-Nosed',
      'Burned', 'Cunning', 'Devious', 'Elder', 'Frost-Touched',
      'Grim', 'Half-Blind', 'Hollow-Eyed', 'Iron-Bellied', 'Lopsided',
      'Many-Scarred', 'Notorious', 'Old', 'One-Eyed', 'Scarred',
      'Thick-Skulled', 'Twice-Cursed', 'Wily', 'Withered', 'Young-No-More',
    ],
    epithets: [
      'the Bone-Collector', 'the Deep-Crawler', 'the Dust-Reader', 'the Ever-Hungry',
      'the Fearless', 'the Fumble-Fingers', 'the Hoard-Keeper', 'the Unkillable',
      'the Ladle-Tyrant', 'the Last One Standing', 'the Mushroom-King', 'the Night-Prowler',
      'the Oathbreaker', 'the Pit-Delver', 'the Rat-Speaker', 'the Scar-Collector',
      'the Tooth-Breaker', 'the Wall-Carver', 'the Worm-Whisperer', 'the Twice-Buried',
      'the Grudge-Keeper', 'the Hollow-Voiced',
    ],
    of_phrases: [
      'of the Ash-Heap', 'of the Burned Bridge', 'of the Dark Tunnels', 'of the Deep Places',
      'of the Drained Hoard', 'of the Endless Mud', 'of the Fallen Warren', 'of the First Night',
      'of the Forgotten Feast', 'of the Great Dig', 'of the Iron Hill', 'of the Last Fire',
      'of the Last Raid', 'of the Long Road', 'of the Mushroom War', 'of the Old Grudge',
      'of the Rat-King\'s Ruin', 'of the Ruined Gate', 'of the Three Scars', 'of the Twice-Burned Hall',
      'of the Crooked Path', 'of the Empty Hoard',
    ],
    traits: [
  ...
  // --- Saga endings (L4) -----------------------------------------
  // The TRUE meta-endings, reached only after the final life's Reckoning, when the
  // Bargain comes due. Distinct from the per-life GG.ENDINGS. The doors a player
  // can take are gated by cumulative deeds/Legend (Game.sagaFinaleOptions); 'pay'
  // is always available, 'break'/'turn' must be earned across the Saga.
  GG.SAGA_ENDINGS = {
    pay:   { name: 'The Price Paid' },
    break: { name: 'The Bargain Broken' },
    turn:  { name: 'The Bargain Turned' },
  };
